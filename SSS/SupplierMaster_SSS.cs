...
namespace SSS
{
    public partial class SupplierMaster_SSS : Form
    {
        ...
        public SupplierMaster_SSS(int sStatus, string strGroup, string strCategory)
        {
            try
            {
                InitializeComponent();
        ...
        public SupplierMaster_SSS(string sParty)
        {
            InitializeData(sParty);
        }

        public SupplierMaster_SSS(string sParty, int status)
        {
            InitializeData(sParty);
            update = status;
        }
        ...
        private void SaveRecord()
        {
            try
            {
                ...
                record[53] = txtTransactionLock.Text;
                record[54] = txtOrangeList.Text;
        ...
        private void ClearAllData()
        {
            try
            {
                ...
                txtGroup.Text = txtState.Text=txtTransactionLock.Text=txtOrangeList.Text = txtOtherGroup.Text = pt.txtTransportI.Text = pt.txtTransportII.Text = txtAadharNumber.Text = txtSaleIncentive.Text = txtGSTNo.Text = txtPANNumber.Text = "";
        ...
        private void SupplierMaster_KeyDown(object sender, KeyEventArgs e)
        {
            try
            {
                ...
                else if (e.KeyCode == Keys.Enter && !txtAddress.Focused && !txtPerAddress.Focused && !txtBlackList.Focused && !txtTransactionLock.Focused && !txtOrangeList.Focused && !dgrdBank.Focused && !dgrdBrandName.Focused)
                {
                    SendKeys.Send("{Tab}");
                }
            }
        ...
        private void BindPartyRecordFromDataRow(DataRow dr)
        {
            ...
            txtTransactionLock.Text = Convert.ToString(dr["TransactionLockRemark"]);
            txtOrangeList.Text = Convert.ToString(dr["OrangeListRemark"]);
        ...
        {
            txtBlackList.ReadOnly = !chkBlackList.Checked;
        }
        ...
        {
            txtDOA.ReadOnly = txtDOB.ReadOnly = txtSpouse.ReadOnly = txtName.ReadOnly = txtAddress.ReadOnly = txtPerAddress.ReadOnly = txtPIN.ReadOnly = txtGSTNo.ReadOnly = txtPANNumber.ReadOnly = txtOpening.ReadOnly = txtContactPer.ReadOnly = txtMobile.ReadOnly = txtAccountentMobileNo.ReadOnly = txtPhone.ReadOnly = txtSSSName.ReadOnly = txtPvtMarka.ReadOnly = txtEmailID.ReadOnly = txtAadharNumber.ReadOnly = txtRemark.ReadOnly = txtNormalDhara.ReadOnly = txtSNetDhara.ReadOnly = txtPremiumDhara.ReadOnly = txtDueDays.ReadOnly = txtSchemedhara.ReadOnly = txtPremiumDhara.ReadOnly = txtPostage.ReadOnly = txtDate.ReadOnly = txtSaleIncentive.ReadOnly = txtBlackList.ReadOnly = txtAccountentMobileNo.ReadOnly =txtTransactionLock.ReadOnly=txtOrangeList.ReadOnly= false;
        ...
        {
            txtTransactionLock.ReadOnly = !chkTransaction.Checked;
        }

        private void chkOrangeZone_CheckedChanged(object sender, EventArgs e)
        {
            txtOrangeList.ReadOnly = !chkOrangeZone.Checked;
        }
